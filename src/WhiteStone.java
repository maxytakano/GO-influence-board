...
/**
 * A White stone that can be placed on a Goban.
 * <P>
...
{
	/**
	 * Create a White stone with a default width and height.
	 */
	public WhiteStone() { }

	/**
	 * Create a new White stone with a specific width and height.
	 *
	 * @param width -- The stone's width (in pixels).
	 * @param height -- The stone's height (in pixels).
	 */
	public WhiteStone( int width, int height )
	{
		super( width, height );
	}

	/**
	 * Create a new White stone with a specific image.
	 *
	 * @param stoneImage -- The image to use when drawing this stone.
	 */
	public WhiteStone( Image stoneImage )
	{
		super( stoneImage );
	}

	/**
	 * Returns true, since this is a White stone.
	 *
